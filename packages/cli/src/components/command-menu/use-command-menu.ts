...
export function useCommandMenu(): UseCommandMenuReturn {
  ...
  // Resolve a command at a specific index (returns the command, caller
  // handles execution)
  ...
  // Arrow keys move selection; the list follows along when
  useKeyboard((key) => {
    ...
    if (key.name === "escape") {
      ...
      setSelectedIndex((i: number) => {
        ...
        if (sb) {
          ...
          // Jump to bottom when scrolling past the edge
